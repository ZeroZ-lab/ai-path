---
theme: ../guan-theme
title: Dify - Next-Generation AI Application Platform
info: Dify Docker Deployment with Legal Case Study
...
<!--
Hello everyone, welcome to today's Dify practical course. Over the past while, we may have all tried using ChatGPT or Claude directly for conversations, but how do we turn these powerful models into our own "digital employees," or even an automated legal expert? This is exactly the problem Dify solves. Today I will guide you from scratch—not just learning how to deploy, but also how to build your own AI applications.
-->
...
---
src: ./pages/08-01-debug-preview.md
hide: false
---

---
src: ./pages/08-02-publish-version.md
hide: false
---

---
src: ./pages/08-03-ops-monitoring.md
hide: false
---
...
---
src: ./pages/09-00-why-rag.md
hide: false
---

---
src: ./pages/09-00-why-rag-solution.md
hide: false
---
