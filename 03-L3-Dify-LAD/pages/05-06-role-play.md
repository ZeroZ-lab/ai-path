...
<!--
光说不练假把式，现在我们请 4 位同学上台，我们现场来“演”一个工作流。

**第一个工位（开始节点）**：你就是用户的嘴，负责大声说出需求，比如：“帮我写个请假条”。
**第二个工位（LLM大脑）**：你负责“加工”，要把请假条写出来。
**第三个工位（审核员）**：你是判官。如果请假条里没写理由，你就举牌“重写”，让他退回到大脑重来；如果写得好，就举牌“通过”传给下一位。
**第四个工位（结束节点）**：你是发布者，展示最后那份合格的请假条。

**大家观察一下：**
1.  这个过程中，谁手里的“纸条”（变量）传给了谁？
2.  如果“审核员”不给力，是不是最后出来的成品就有问题？这就是为什么节点配置很关键。

这个实验告诉我们：**工作流就是把人类的协作逻辑，变成了机器的执行逻辑。**
-->
